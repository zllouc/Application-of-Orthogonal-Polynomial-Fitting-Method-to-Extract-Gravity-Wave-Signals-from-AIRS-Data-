%%%%%%%%%%%%%%%WAVETEST Example Matlab script%%%%%%%%%%% 
%%%%%%%%%%%%%for WAVELET%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% 
%%%%%%%%%%%%%%using NINO3 SST dataset%%%%%%%%%%%%%%%%%%%
%%See "http://paos.colorado.edu/research/wavelets/"%%%%%
%%%%%%%Written January 1998 by C. Torrence%%%%%%%%%%%%%%
%%Modified Oct 1999, changed Global Wavelet Spectrum%%%% 
%%%%%%%%%(GWS) to be sideways%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%changed all "log" to "log2", changed%%%%%%%%%%%%
%%%%%%%%%logarithmic axis on GWS to%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%a normal axis%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
load 'sst_nino3.dat';  
...
%%%%%%%%to compare with plot on Interactive%%%%%%%%%%%%%
%%%%%%%%Wavelet page, at%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%SST数据的矢量长度%%%%%%%%%%%%%%%%%%%%
dt = 0.25;
%%%%%%%%%%%%sst数据有504个共130年（1870-2000）%%%%%%%%
%%%%%就是说一年应该是四个数据，即每季度一个数据%%%%%%%%%%%%
%%%%%%%%%也就是每两个数据之间是0.25年%%%%%%%%%%%%%%%%%%
timedt = (0:(n-1))*dt; 
time = timedt + 1871.0;  
...
%%%%%%%%%%%%%%%绘图时x轴范围%%%%%%%%%%%
pad = 1;      
%%%%%%%pad the time series with zeroes%%%%%%%%%%%% 
%%%%%%%%(recommended)%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%填补模式为1%%%%%%%%%%%%%%%%%%%%%%%%%%
dj = 0.25;    
...
%%%%%%%%可分辨的最小尺度为半年%%%%%%%%%%%%%%%%%%%
j1 = 7/dj;    
%%%%%%%%this says do 7 powers-of-two%%%%%%%%%%% 
%%%%%%%with dj sub-octaves each%%%%%%%%%%%%%
%%%%%%%这句话说的是做7个2次方，每个次方有dj个八度%%%%
lag1 = 0.72;  
%%%%%%%lag-1 autocorrelation for%%%%%%
