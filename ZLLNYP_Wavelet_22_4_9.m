...
levels = (-6.5:0.7:6.5);  %for color figure 
%%levels = (-20:1:20);  %for color figure 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%v = [0,0.5,1.0,1.5];
...
title('(c)Real Wave');
%%%set(title('(a) Latitude:23.76°N Height:30km WS'),'FontName','Times New Roman','FontSize',18,'Color','b')
set(title('c)Real Wave'),'FontName','Times New Roman','FontSize',12,'Color','b')
xlabel(' ')
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
set(title('d) WS(Morlet)'),'FontName','Times New Roman','FontSize',12,'Color','b')
colorDepth = 1000;
colormap(jet(colorDepth));
xlabel('Distance (km)')
ylabel('wavelength(km)')
...
set(title('e) Global WPS'),'FontName','Times New Roman','FontSize',12,'Color','b')
colorDepth = 1000;
colormap(jet(colorDepth));
set(gca,'FontName','Times New Roman','FontSize',12);
set(findobj('FontSize',12),'FontSize',figure_FontSize);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
print(gcf,'zll-wrf-w-wavelet.eps','-depsc2', '-r600');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%end of code%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
